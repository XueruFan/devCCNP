# this code is used to arrange CCNPPEK SASC result into tsv file
...
setwd(paste0(filefolder, "/DataArrange/SASC"))
for (i in 1:nrow(sasc)) {
  data <- sasc[i,]
  dataname <- paste0("CCNPPEK", sasc[i, 1], "_ses-", sasc[i, 2], "_task-SASC_beh.tsv")
