# this code is used to arrange CCNPPEK DOSPERT result into tsv file
...
######################## Arrange DOSPERT result ######################################################

dospert <- raw[, c(1,2, 933:965)]
setwd(paste0(filefolder, "/RawData/"))

# save a copy of raw data
write.xlsx(dospert, "CCNPPEK_DOSPERT_raw.xlsx", rowNames = F, colNames = F)
