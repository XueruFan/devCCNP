# this code is used to arrange CCNPPEK CLS result into tsv file
...
setwd(paste0(filefolder, "/DataArrange/CLS"))
for (i in 1:nrow(cls)) {
  data <- cls[i,]
  dataname <- paste0("CCNPPEK", cls[i, 1], "_ses-", cls[i, 2], "_task-CLS_beh.tsv")
