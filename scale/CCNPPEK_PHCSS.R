# this code is used to arrange CCNPPEK PHCSS result
...
rawfile <-  "CCNPPEK_Scale_B_Batch4.xlsx"
rawdata <- read.xlsx(rawfile, rowNames = F)
rawdata <- rawdata[, -1:-2]

######################## Arrange PHCSS result 

phcss <- rawdata[, c(1,2, 34:113)]

setwd(file.path(filefolder, "raw"))
# save a copy of raw data
write.xlsx(phcss, "CCNPPEK_PHCSS_Batch1234_raw.xlsx", rowNames = F, colNames = F)
...
write.xlsx(phcss, "CCNPPEK_PHCSS_Batch1234.xlsx", rowNames = F, colNames = T)
