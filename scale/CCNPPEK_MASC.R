...
masc <- rawdata[, c(1,2, 366:404)]

setwd(file.path(filefolder, "raw"))
# save a copy of raw data
write.xlsx(masc, "CCNPPEK_MASC_Batch1234_raw.xlsx", rowNames = F, colNames = F)
...
write.xlsx(masc, "CCNPPEK_MASC_Batch1234.xlsx", rowNames = F, colNames = T)
