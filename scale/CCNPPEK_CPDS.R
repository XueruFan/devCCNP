...
cpds <- rawdata[, c(1,2, 3:15)]
setwd(file.path(filefolder, "raw"))

# save a copy of raw data
write.xlsx(cpds, "CCNPPEK_C-PDS_Batch1234_raw.xlsx", rowNames = F, colNames = F)
