# this code is used to arrange CCNPPEK PANAS result
...
panas <- rawdata[, c(1,2, 191:210)]

setwd(file.path(filefolder, "raw"))
# save a copy of raw data
write.xlsx(panas, "CCNPPEK_PANAS_Batch1234_raw.xlsx", rowNames = F, colNames = F)
...
write.xlsx(panas, "CCNPPEK_PANAS_Batch1234.xlsx", rowNames = F, colNames = T)
