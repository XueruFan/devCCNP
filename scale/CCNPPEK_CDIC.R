# this code is used to arrange CCNPPEK CDIC result
...
cdic <- rawdata[, c(1,2, 164:190)]

setwd(file.path(filefolder, "raw"))
# save a copy of raw data
write.xlsx(cdic, "CCNPPEK_CDIC_Batch1234_raw.xlsx", rowNames = F, colNames = F)
...
write.xlsx(cdic, "CCNPPEK_CDIC_Batch1234.xlsx", rowNames = F, colNames = T)
